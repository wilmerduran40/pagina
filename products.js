const productsData = [
  {
    ...
    "description": "Características destacadas:\n\nDoble lente de 3MP: Cubre más espacio con una calidad de imagen nítida.\n\nVisión nocturna a color: Imágenes claras, incluso en la oscuridad total.\n\nDetección inteligente y seguimiento automático: Recibe alertas instantáneas y observa cómo la cámara sigue los movimientos automáticamente.\n\nConexión WiFi de amplio alcance y app móvil: Controla y monitorea todo desde tu celular, sin puntos ciegos.\n\nAlmacenamiento flexible: Guarda tus grabaciones en una tarjeta SD o en la nube para mayor seguridad.",
    "stock": 1,
    "additional_images": [],
    "videos": []
  },
  {
    "name": "Proyector Portátil HY300 4K",
    "price": 65.00,
    "image": "imagenes/proyector.jpg",
    "description": "Proyector Inteligente Calidad de imagen: Disfruta de una resolución HD de 720p con soporte para contenido en 4K. Android 11 integrado: Accede a tus aplicaciones favoritas como Netflix y YouTube sin necesidad de dispositivos externos. Conectividad de última generación: Con WiFi 6 y Bluetooth 5.0, tendrás conexiones rápidas y establesPantalla gigante: Proyecta imágenes de hasta 130 pulgadas en cualquier pared o techo..",
    "stock": 0,
    "additional_images": [],
  ...
  {
    "name": "Camara Bombillo 360º",
    "price": 25.00,
    "image": "imagenes/camara_bombillo.jpg",
    "description": "Visión de 360°: Con su lente panorámica, podrás ver cada rincón de la habitación directamente desde tu teléfono.\n\nImágenes nítidas y visión nocturna a color: Disfruta de una vigilancia 24/7 con una calidad de imagen clara, tanto de día como de noche.\n\nFácil instalación y conexión: Solo tienes que enroscarla y conectarla a tu WiFi en minutos para empezar a usarla.\n\nMonitoreo desde tu celular: La aplicación móvil te permite ver las grabaciones y controlar la cámara desde cualquier lugar, dándote total tranquilidad.",
    "stock": 5,
    "additional_images": [],
    "videos": []
  },
